...
// 		Callback<void(UIEventResponder responder, UIEvent event)>::func =
// 			std::bind(&EventResponder::_leftMouseDown, this, std::placeholders::_1, std::placeholders::_2);
// 		this->backing_responder->leftMouseDown =
// 			static_cast<callback_t>(Callback<void(UIEventResponder responder, UIEvent event)>::callback);
// 	}
